...
#### 参数: CustomAdjacentObject 指定/自定义相邻对象
    ...
    默认值是 'NONE' ，在 Ruivo_AdjacencyType 表也就是[相邻来源类型表](./refer_table-参考表/Ruivo_AdjacencyType.xlsx)中，HasCustomAdjacentObject 为 1

 的相邻来源才有必要填 CustomAdjacentObject ，其他的相邻来源不填都没关系。
